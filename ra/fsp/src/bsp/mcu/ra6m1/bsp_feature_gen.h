...
#define BSP_PERIPHERAL_ACMPHS_CHANNEL_MASK            (0x3F)
...
#define BSP_PERIPHERAL_CAN_CHANNEL_MASK               (0x3)
...
#define BSP_PERIPHERAL_GPT_CHANNEL_MASK               (0x1FFF)
#define BSP_FEATURE_GPT_AD_DIRECT_START_SUPPORTED     (0)
#define BSP_FEATURE_GPT_EVENT_COUNT_SUPPORTED         (1)
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK      (0x1FFF)
#define BSP_FEATURE_GPT_GPTE_SUPPORTED                (1)
#define BSP_FEATURE_GPT_GPTE_CHANNEL_MASK             (0xF0)
...
#define BSP_FEATURE_GPT_GTDVU_CHANNEL_MASK            (0x1FFF)
...
#define BSP_PERIPHERAL_ICU_EXT_IRQ_CHANNEL_MASK       (0x3FFF)
...
#define BSP_PERIPHERAL_IRDA_PRESENT                   (1)
...
#define BSP_PERIPHERAL_MMF_PRESENT                    (1)
...
#define BSP_PERIPHERAL_PORT_CHANNEL_MASK              (0xFF)
...
#define BSP_FEATURE_RSIP_SCE7_SUPPORTED               (1)
#define BSP_FEATURE_RSIP_SCE9_SUPPORTED               (0)
#define BSP_FEATURE_RSIP_TRNG_SUPPORTED               (0)
#define BSP_PERIPHERAL_SCI_PRESENT                    (1)
#define BSP_PERIPHERAL_SCI_CHANNEL_MASK               (0x31F)
#define BSP_FEATURE_SCI_IRDA_SUPPORTED                (1)
#define BSP_FEATURE_SCI_IRDA_CHANNEL_MASK             (0x2)
...
#define BSP_PERIPHERAL_SRCRAM_PRESENT                 (1)
#define BSP_PERIPHERAL_SRC_PRESENT                    (1)
